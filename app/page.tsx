  ...
  return (
    <main className="page-root">
      ...
      <section id="cinematic" className="section cinematic-section" aria-labelledby="cinematic-title">
        <p className="eyebrow">EARTH SCHOOL • A Temporary Human Experience</p>
        <h2 id="cinematic-title">WATCH THE OFFICIAL CINEMATIC TRAILER</h2>
        <p className="section-text">
          The first cinematic glimpse into EARTH SCHOOL introduces the neon diner, the awareness
          shift, the perception filter, the Lens, the Sanctuary, Maya, John, Mrs. Chen, and the
          beginning of the temporary human experience.
        </p>
        <div className="video-placeholder trailer-embed">
          <iframe
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .trailer-note {
          ...
          line-height: 1.6;
          text-align: center;
          text-shadow: 0 0 16px rgba(255, 79, 216, .38);
        }
        .diner-lines {
          display: grid;
          gap: .75rem;
