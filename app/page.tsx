...
export default function Page() {
  return (
    <main className="page-root">
      ...
      <section id="trailer" className="section cinematic-section trailer-section" aria-labelledby="trailer-title">
        <p className="eyebrow">EARTH SCHOOL • OFFICIAL CINEMATIC TRAILER</p>
        <h2 id="trailer-title">WATCH THE FIRST GLIMPSE INTO EARTH SCHOOL</h2>
        <p className="section-text trailer-copy">
          Experience the world, the characters, and the core gameplay vision behind EARTH SCHOOL in this first cinematic reveal.
        </p>
        <div className="video-frame">
          <iframe
            src="https://www.youtube.com/embed/MLG2-Nu9YAQ"
            title="EARTH SCHOOL official cinematic trailer"
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .video-frame {
          ...
          overflow: hidden;
          border-radius: 2rem;
          box-shadow: 0 0 42px rgba(39, 216, 255, .18), 0 0 72px rgba(255, 79, 216, .12), inset 0 0 36px rgba(255, 79, 216, .06);
        }
        .video-frame iframe {
          position: absolute;
          inset: 0;
